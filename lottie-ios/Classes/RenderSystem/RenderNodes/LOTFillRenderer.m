...
- (void)performLocalUpdate {
  centerPoint_DEBUG.backgroundColor = self.renderSettings.fixedFillColor.CGColor ?: [colorInterpolator_ colorForFrame:self.currentFrame];
  centerPoint_DEBUG.borderColor = [UIColor lightGrayColor].CGColor;
  centerPoint_DEBUG.borderWidth = 2.f;
  self.outputLayer.fillColor = self.renderSettings.fixedFillColor.CGColor ?: [colorInterpolator_ colorForFrame:self.currentFrame];
