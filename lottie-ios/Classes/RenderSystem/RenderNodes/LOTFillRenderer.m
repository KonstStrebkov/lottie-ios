...
- (void)performLocalUpdate {
  centerPoint_DEBUG.backgroundColor = self.renderSettings.fixedFillColor ?: [colorInterpolator_ colorForFrame:self.currentFrame];
  centerPoint_DEBUG.borderColor = [UIColor lightGrayColor].CGColor;
  centerPoint_DEBUG.borderWidth = 2.f;
  self.outputLayer.fillColor = self.renderSettings.fixedFillColor ?: [colorInterpolator_ colorForFrame:self.currentFrame];
